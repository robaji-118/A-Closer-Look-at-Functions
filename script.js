...
//   // 1. Method to register new answer
//   registerNewAnswer() {
...
// // 2. Hooking up button click to method
// document
//   .querySelector('.poll')
...
// The header variable is "stuck" in memory via a closure, even though its original scope has ended.

// That's why we don't need to call document.querySelector('h1') again on every click.
